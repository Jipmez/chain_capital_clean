        ...
        <div class="col-xl-12">
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div align="right">Kindly create a withdrawal method if you have none click here to create >>></div><div class="card-header-links">
                        <a href="{{ route('user.withdraw.account.index') }}"
                           class="card-header-link">{{ __('Withdraw Method') }}</a>
                    </div>
                </div>
