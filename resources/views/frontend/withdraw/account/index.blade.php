        ...
        <div class="col-xl-12">
            <div class="site-card">
                <div class="site-card-header">
                    ...
                    <div class="card-header-links">Click here to create a new withdraw method
                            ...
                            <div class="single">
                                <div class="left">
                                    ...
                                    <div class="content">
                                      ...
                                      <div class="action">
                                        <a href="{{ route('user.withdraw.account.edit',$account->id) }}"><i icon-name="edit"></i> Edit existing account</a>
                                    </div></div>
                                </div>
                            </div>
                        @endforeach
