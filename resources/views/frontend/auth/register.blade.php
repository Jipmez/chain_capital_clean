        ...
        <div class="row justify-content-center">
            <div class="col-xl-8 col-md-12">
                <div class="auth-content" align="center">
                    <div align="center">
                        <a href="{{ route('home')}}"><img src="images/chain_logo.png" width="120px" align="center" /></a>
                        <hr>
                    </div>
                    <div class="title">
                        <h4>HELLO! SIGNUP AN ACCOUNT</h4>
                    </div>
                    @if ($errors->any())
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="single-field">
                                    ...
                                    <select name="country" id="countrySelect" class="site-nice-select">
                                        ...
                                        <option value="{{ $country['name'].':'.$country['dial_code'] }}" data-code="{{ $country['dial_code'] }}">
                                            {{ $country['name']  }}
                                        </option>
                                        @endforeach
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function() {
            const dialCode = dialCodeSpan.textContent.trim();

            if (!phoneInput.value.startsWith(dialCode)) {
                phoneInput.value = dialCode + phoneInput.value;
            }
        });
