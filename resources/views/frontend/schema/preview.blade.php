                            ...
                            <div class="transaction-list table-responsive">
                                <table class="table preview-table">
                                    ...
                                    <tr style="display:none;">
                                        <td><strong>{{ __('Select Plan:') }}</strong></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="input-group mb-0">
                                                <select class="site-nice-select" aria-label="Default select example"
                                                    ...
                                                    <option
                                                        value="main">{{ __('Balance ( ') . $user->balance.' '. $currency }}
                                                        )
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td id="return-interest">{{ ($schema->interest_type == 'percentage' ? $schema->return_interest.'%' : $schema->return_interest.' '.$currency ) .' Every '.$schema->schedule->name .'' }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>{{ __('Duration:') }}</strong></td>
                                        <td id="number-period">{{( $schema->return_type == 'period' ? $schema->number_of_period : 'Unlimited').($schema->number_of_period == 1 ? ' Time' : ' '.$schema->schedule->name .'(s)' )  }} </td>
                                    </tr>
                                    <tr>
