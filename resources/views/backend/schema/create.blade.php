...
@section('content')
                    ...
                    <div class="site-card">
                        <div class="site-card-body">
                            <form action="{{route('admin.schema.store')}}" method="post" enctype="multipart/form-data"
                                ...
                                <div class="col-xl-6">
                                    <div class="site-input-groups">
                                        <label class="box-input-label" for="">{{ __('Return Duration:') }}</label>
                                        <select name="return_period" class="form-select" id="returnPeriodSelect">
    ...
    @endforeach
                                    ...
                                    <div class="site-input-groups">
                                        ...
                                        <div class="switch-field same-type">
                                            <input
                                                ...
                                                value="period"
                                            />
                                            <label for="return-type-period">{{ __('Duration') }}</label>
                                            <input
                                                type="radio"
                                ...
                                <div class="col-xl-6 number-period">
                                    <div class="site-input-groups">
                                        <label class="box-input-label" for="">{{ __('Number of Duration:') }}</label>
                                        <div class="input-group joint-input">
                                            <input
                                                type="text"
                                                ...
                                                class="form-control"
                                                placeholder="Total number of duration"
                                                required
                                            />
                                            <span class="input-group-text"><text id="selectedValueBox"></text>(s)</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-12">
...
document.addEventListener('DOMContentLoaded', function () {
    const selectElement = document.getElementById('returnPeriodSelect');
    const displayBox = document.getElementById('selectedValueBox');

    selectElement.addEventListener('change', function () {
        const selectedOption = selectElement.options[selectElement.selectedIndex];
        displayBox.textContent = selectedOption.text;
        displayBox.style.display = 'block'; // Ensure the box is visible
    });

    // If you want to display the initially selected value on page load
    const initialSelectedOption = selectElement.options[selectElement.selectedIndex];
    if (initialSelectedOption) {
        displayBox.textContent = initialSelectedOption.text;
