    ...
    var k = x(n),
        ...
        l =
            ...
            (w.Util.imageBG = function () {
                ...
                a.exists() &&
                    a.each(function () {
                        ...
                        void 0 !== o &&
                            "" !== o &&
                            (e.hasClass("has-bg-image") ||
                                e.addClass("has-bg-image"),
                            t
                                ? a.hasClass("overlay-" + t) ||
                                  (a.addClass("overlay"),
                                  a.addClass("overlay-" + t))
                                : a.hasClass("overlay-fall") ||
                                  a.addClass("overlay-fall"),
            ...
            (w.MainMenu = function () {
                var e = x(".navbar-toggle"),
                    ...
                    r = {
                        ...
                        mobileNav: function () {
                            k.width() < m
                                ? t.delay(500).addClass("f")
                                : (t.delay(500).removeClass("df"),
                                  t.removeClass(l));
                        },
            ...
            (w.OnePageScroll = function () {
                x('a.menu-link[href*="#"]:not([href="#"])').on(
                    "click",
                    function () {
                        if (
                            ...
                            var a = this.hash,
                                e =
                                    !!this.hash.slice(1) &&
                                    x("[name=" + this.hash.slice(1) + "]"),
                                a = a.length ? x(a) : e;
                            if (a.length)
                                return (
                                    x(".navbar-toggle").removeClass("active"),
                                    x(".header-navbar").removeClass(
                                        "menu-shown"
                                    ),
                                    x("html, body").scrollTop(
                                        a.offset().top - o
                                    ),
                                    !1
                                );
                ...
                function y(a) {
                    ...
                    !a.hasClass("blank-added") && 575 < k.width()
                        ? (a.trigger("add.owl.carousel", [
                          ...
                          a
                              .addClass("blank-added")
                              .removeClass("blank-removed"),
                        ...
                        : !a.hasClass("blank-removed") &&
                          ...
                          a
                              .addClass("blank-removed")
                              .removeClass("blank-added"),
                          a.trigger("refresh.owl.carousel"));
                }
                a.exists() &&
                    a.each(function () {
                        var a = x(this),
                            ...
                            n = a.data("items-mobile")
                                ...
                                ? o - 1
                                : o,
                            n = a.data("items-mobile-s")
                                ? a.data("items-mobile-s")
                                : n,
                            ...
                            v = a.data("margin-tab-l")
                                ? a.data("margin-tab-l")
                                : h,
                            g = a.data("margin-tab-p")
                                ? a.data("margin-tab-p")
                                : v,
                    ...
                    a.each(function () {
                        var a = x(this),
                            ...
                            t = a.data("select2-placehold")
                                ...
                                : "Select an option",
                            s =
                                a.data("search") && "on" === a.data("search")
                                    ? 1
                                    : -1;
                        a.select2({
                            placeholder: t,
            ...
            (w.Plugins.submitform = function () {
                ...
                if (!x().validate && !x().ajaxSubmit)
                    return (
                        console.log(
                            "jQuery Form and Form Validate not Defined."
                        ),
                        !0
                    );
                a.exists() &&
                ...
                a.exists() &&
                    a.each(function () {
                        var a = x(this),
                            ...
                            s = !(void 0 === s || !s) && s,
                            n = !(void 0 === n || !n) && n;
                        e.hasClass("has-bg-video") ||
                            e.addClass("has-bg-video"),
                            t
                                ? a.hasClass("overlay-" + t) ||
                                  (a.addClass("overlay"),
                                  a.addClass("overlay-" + t))
